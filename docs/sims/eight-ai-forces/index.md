...
5. **B1 — Compute Constraint** — chip supply, datacenters, gigawatts of power.
6. **B2 — Evaluation Bottleneck** — you cannot self-improve faster than you can self-evaluate.
7. **B3 — Diffusion / Fast-Follow** — papers leak, employees move, ideas spread.
8. **B4 — Cost-Performance Friction** — production agents route to the cheapest competent model.
